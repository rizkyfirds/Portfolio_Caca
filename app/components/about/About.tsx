...
const About = () => {
  return (
    <div className="flex h-fit w-full py-[24px] lg:py-[80px] w-full bg-white">
      <div className="h-fit w-4/5 lg:w-3/5 mx-auto grid gap-y-[22px] lg:gap-y-[40px] text-[15px] lg:text-[25px]  font-medium text-justify text-[#373737]">
        <p>
        ...
        <p className="relative">
          ...
          <Image
            ...
            className="w-[50px] lg:w-[120px] absolute z-10 -bottom-6 -right-4 lg:-bottom-14 lg:-right-14"
          />
        </p>
      </div>
    </div>
